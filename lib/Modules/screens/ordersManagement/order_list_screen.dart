...
class OrderList extends ParentWidget {
  ...
  Widget actionButtons(double w, Data? steps, GetOrderController controller) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        commonButton(
  ...
  Color orderStatusColor(Data? steps, GetOrderController controller) {
  ...
  String orderStatusString(Data? steps, GetOrderController controller) {
  ...
  String orderConfirmedString(Data? steps, GetOrderController controller) {
    return (steps?.artisanAgreedStatus == OrderStatus.ACCEPTED.name && steps?.buildStatus == OrderStatus.ADMIN_APPROVED.name && steps?.transitStatus == OrderStatus.DELIVERED.name)
