            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  buildProfileOptionCard(appStrings.settings, appStrings.settingsSubtitle, Icons.settings_outlined, () => Get.toNamed(RoutesClass.setting)?.then((onValue) => controller.commonController.getProfileApi())),
