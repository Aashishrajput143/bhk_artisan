            ...
            child: Stack(
              ...
              children: [
                AnimatedBuilder(
                  ...
                  child: Image.asset(appImages.loaderouter),
                ),
                Image.asset(appImages.logo, width: 70, height: 70),
              ],
            ),
          ),
          Positioned(
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 21, fontWeight: FontWeight.bold, color: appColors.brownDarkText),
            ),
          ),
        ],
      ),
