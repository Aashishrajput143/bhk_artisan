...
class LogisticsDetailsController extends GetxController {
  ...
  final logisticsModel = GetLogisticsDetailsModel().obs;
  void setError(String value) => error.value = value;
  RxString error = ''.obs;
  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setLogisticsDetailsdata(GetLogisticsDetailsModel value) => logisticsModel.value = value;
  ...
  Future<void> getLogisticsApi() async {
    ...
    if (connection == true) {
      ...
      _api.getLogisticsDetailsApi(id.value).then((value) {
        setLogisticsDetailsdata(value);
